...
Revision ID: a6ebd63b0099
Revises: 
Create Date: 2023-03-21 23:28:02.184487
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('local', sa.String(length=30), nullable=False),
    ...
    sa.Column('fired', sa.Date(), nullable=True),
